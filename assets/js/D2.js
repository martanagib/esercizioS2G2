...
if(num4%5==0){
  ...
  console.log('il numero dato non è un multiplo di 5');
}
/* ESERCIZIO 4
...
console.log('con i valori dati si potrebbe arrivare a 8'); 
}
else {
  console.log('con i valori dati non arriveremo mai a 8');
}
/* ESERCIZIO 5
...
if (totalShoppingCart>50){
 ...
 document.getElementById('esercizio5').innerHTML= "paghi la spedizione";
...
let spedizione=10;
let totalShoppingCart3=(totalShoppingCart2/100)*20;
totalShoppingCart2-=totalShoppingCart3;
let totale;
